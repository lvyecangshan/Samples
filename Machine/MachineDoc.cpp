...
// MachineDoc.cpp : implementation of the CMachineDoc class
//
...
// CMachineDoc construction/destruction
...
void CMachineDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CMachineDoc::InitializeSearchContent()
{
...
void CMachineDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
