...
{
	m_clrText = RGB(0,0,0);
	m_clrBack = RGB(0,128,0);
	m_clrLeft = RGB(142,178,236);
	m_clrRight = RGB(14,67,163);
...
void CMyButton::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct) 
{
	...
	if(intButtonFace == 1)
	{
		rgn1.CreateRoundRectRgn(rect.left,rect.top,rect.right,rect.bottom,5,5);
		rgn2.CreateRoundRectRgn(rect.left+1,rect.top+1,rect.right-1,rect.bottom-1,5,5);
	}
	if(intButtonFace == 0)
	{
